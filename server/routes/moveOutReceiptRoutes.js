...
router.get('/move-out-receipts/dormitories/:dormId', authCheck, staffCheck, getMoveOutReceiptsByMonth);

// ดึงข้อมูลใบเสร็จย้ายออกตามห้อง
router.get('/move-out-receipts/dormitories/:dormId/rooms/:roomNumber', authCheck, staffCheck, getMoveOutReceiptData);

// ดึงใบเสร็จย้ายออกตาม ID (ต้องมาหลังสุดเพราะเป็น generic route)
router.get('/move-out-receipts/:moveOutReceiptId', authCheck, staffCheck, getMoveOutReceiptById);
